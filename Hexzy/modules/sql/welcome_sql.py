...
from Hexzy.modules.helper_funcs.msg_types import Types
from Hexzy.modules.sql import BASE, SESSION

DEFAULT_WELCOME = "හායි {first}, ඔයාට කෝමද ? 🙂"
DEFAULT_GOODBYE = "බායි හම්බුනාට සතුටුයි 🥺🖐"

DEFAULT_WELCOME_MESSAGES = [
    "හායි {first} ඔයාට කෝමද ? 🙂",  # Discord welcome messages copied
    "🔥",
    "🙈",
    "🌝",
    "🌟",
    ...
    "🧽",
    "🧼",
    "අප සමූහයට නව සාමාජිකයින් එකතු කල ඔබට ස්තූතියි 🙂 ",
    "💞",  # End of jumanji stuff
]
DEFAULT_GOODBYE_MESSAGES = [
    "බායි {first} හම්බුනාට සතුටුයි 🥺🖐 ",
    "බායි {first} හම්බුනාට සතුටුයි 🥺🖐 ",
    "බායි {first} හම්බුනාට සතුටුයි 🥺🖐 ",
    "බායි {first} හම්බුනාට සතුටුයි 🥺🖐 ",
    "බායි {first} හම්බුනාට සතුටුයි 🥺🖐 ",
